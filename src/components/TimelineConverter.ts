  ...
  private render() {
    this.container.innerHTML = `
      <div class="bg-slate-900 border border-slate-800 rounded-xl p-4 sm:p-5 flex flex-col gap-4 shadow-sm">
        ...
        <div class="bg-slate-950 border border-slate-800 rounded-lg p-3 flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
          <div class="flex-1 flex flex-col gap-1">
            <label class="text-[11px] font-mono text-slate-400">Enter DVR Event Timestamp (From Video Footage):</label>
          ...
          <div class="hidden sm:flex items-center text-teal-400 pt-5">
          ...
          <div class="flex-1 flex flex-col gap-1">
            <label class="text-[11px] font-mono text-slate-400">Calibrated True Chronological Time:</label>
