...
2. Under "Build and deployment", set the source to deploy from the `main` branch.
3. Access the live tool at `https://ryandus.github.io/SyncFlow` (Accessible on mobile for live back-camera frame acquisition).
...
*   **Metadata Parsing:** [ExifReader](https://github.com/mattiasw/ExifReader) (DateTimeOriginal, GPS, camera hardware details)
*   **OCR Engine:** [Tesseract.js](https://tesseract.projectnaptha.com/) 
*   **Exhibit Rendering:** [html2canvas](https://html2canvas.hertzen.com/)

## 🚀 Getting Started

Since SyncFlow is entirely client-side, it can be hosted seamlessly via GitHub Pages or run locally.
